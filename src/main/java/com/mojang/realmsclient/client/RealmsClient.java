...
public class RealmsClient {
    ...
    public RealmsServerAddress func_224904_b(long p_224904_1_) throws RealmsServiceException {
        String s = this.func_224926_c("worlds" + "/v1/$ID/join/pc".replace("$ID", String.valueOf(p_224904_1_)));
    ...
    private boolean func_244733_a(PendingInvite p_244733_1_) {
        try {
            ...
            return this.field_244732_f.getFilterManager().func_244757_e(uuid);
        } catch (IllegalArgumentException illegalargumentexception) {
            return false;
        }
    }
    ...
    private String func_224907_b(String p_224907_1_, @Nullable String p_224907_2_) {
        try {
            return (new URI(field_224944_a.field_224899_e, field_224944_a.field_224898_d, "/" + p_224907_1_, p_224907_2_, null)).toASCIIString();
