...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    public Minecraft(GameConfiguration gameConfig) {
        ...
        SocialInteractionsService socialInteractionsService = this.socialInteractionsService(yggdrasilauthenticationservice, gameConfig);
        ...
        this.filterManager = new FilterManager(this, socialInteractionsService);
        ...
        if (s != null) {
            this.displayScreen(new ConnectingScreen(new MainMenuScreen(), this, s, i));
        } else {
            this.displayScreen(new MainMenuScreen(true));
        }
    ...
    private SocialInteractionsService socialInteractionsService(YggdrasilAuthenticationService authenticationService, GameConfiguration gameConfiguration) {
        try {
            return authenticationService.createSocialInteractionsService(gameConfiguration.userInfo.session.getToken());
        ...
        if (this.world != null) {
            if (!this.isGamePaused) {
                if (!this.gameSettings.field_244601_E && this.func_244600_aM()) {
                    ...
                    this.tutorialToast = new TutorialToast(TutorialToast.Icons.SOCIAL_INTERACTIONS, itextcomponent, itextcomponent1, true);
                    this.tutorial.func_244698_a(this.tutorialToast, 160);
        ...
        while (this.gameSettings.field_244602_au.isPressed()) {
            if (!this.func_244600_aM()) {
                ...
                if (this.tutorialToast != null) {
                    this.tutorial.func_244697_a(this.tutorialToast);
