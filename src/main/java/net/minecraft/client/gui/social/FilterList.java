...
public class FilterList extends AbstractOptionList<FilterListEntry> {
    ...
    public void func_244657_a(NetworkPlayerInfo p_244657_1_, SocialInteractionsScreen.Mode p_244657_2_) {
        ...
        if ((p_244657_2_ == SocialInteractionsScreen.Mode.ALL || this.field_244651_o.getFilterManager().func_244756_c(uuid)) && (Strings.isNullOrEmpty(this.field_244653_q) || p_244657_1_.getGameProfile().getName().toLowerCase(Locale.ROOT).contains(this.field_244653_q))) {
