package dev.fesly.client.theme;
...
public enum Themes {
    ...
    AQUA("Aqua", new Color(185, 250, 255), new Color(79, 199, 200), TextFormatting.AQUA, KeyColors.AQUA),
    ...
    BLASTER("Blaster", new Color(255, 172, 94), new Color(199, 121, 208), LIGHT_PURPLE, KeyColors.ORANGE, KeyColors.PINK, KeyColors.AQUA),
    BLEND("Blend", new Color(71, 148, 253), new Color(71, 253, 160), TextFormatting.AQUA, KeyColors.AQUA, KeyColors.LIME),
    ...
    CHRISTMAS("Christmas", new Color(255, 64, 64), new Color(255, 255, 255), RED, KeyColors.RED, KeyColors.LIME),
    CORAL("Coral", new Color(244, 168, 150), new Color(52, 133, 151), DARK_AQUA, KeyColors.PINK, KeyColors.ORANGE, KeyColors.DARK_BLUE),
    DIGITAL_HORIZON("Digital Horizon", new Color(95, 195, 228), new Color(229, 93, 135), TextFormatting.AQUA, KeyColors.AQUA, KeyColors.RED, KeyColors.PINK),
    ...
    LIME_WATER("Lime Water", new Color(18, 255, 247), new Color(179, 255, 171), TextFormatting.AQUA, KeyColors.AQUA, KeyColors.LIME),
    ...
    OVERDRIVE("Overdrive", new Color(131, 57, 179), new Color(253, 29, 29), DARK_PURPLE, KeyColors.PURPLE, KeyColors.RED, KeyColors.ORANGE),
    ...
    PUMPKIN("Pumpkin", new Color(241, 166, 98), new Color(255, 216, 169), GOLD, KeyColors.ORANGE),
    ...
    SNOWY_SKY("Snowy Sky", new Color(1, 171, 179), new Color(234, 234, 234), TextFormatting.AQUA, KeyColors.AQUA, KeyColors.GRAY),
    ...
    WATER("Water", new Color(12, 232, 199), new Color(12, 163, 232), TextFormatting.AQUA, KeyColors.AQUA, KeyColors.DARK_BLUE),
    ...
    WOOD("Wood", new Color(79, 109, 81), new Color(170, 139, 87), DARK_GREEN, KeyColors.DARK_GREEN);
    ...
    Themes(String themeName, Color firstColor, Color secondColor, TextFormatting chatAccentColor, KeyColors... keyColors) {
    ...
    public Color getFadeTheme() {
        return getFadeTheme(10, 0);
    }

    public Color getFadeTheme(int speed, int index) {
        return ColorUtil.interpolateColorsBackAndForth(speed, index, getFirstColor(), getSecondColor());
    }
